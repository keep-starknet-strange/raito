...
// pub use sha256::compute_sha256_byte_array;
// pub use sha256::compute_sha256_u32_array;

// Let's use core non provable functions for now. Much faster.
pub use core::sha256::compute_sha256_byte_array;
pub use core::sha256::compute_sha256_u32_array;

#[cfg(test)]
mod tests {
    use super::sha256::compute_sha256_byte_array;
