...
- Raito can work in tandem with [Raito](https://github.com/keep-starknet-strange/raito) that enables verification of Bitcoin Script programs. Raito = Consensus and Raito = Execution.

![Raito and Raito](./docs/img/memes/raito_raito_fusion.jpg)
