...
//     fn encode_to(self: @Transaction, ref dest: ByteArray) -> usize {
//         self.encode_transaction_to(ref dest, false);
//         1
//     }
// fn bytes_size(self: @Transaction) -> usize {
...
//                     pk_script:
//                     @from_hex("76a914552362dca64805372f3a1c1bfbe190bd148569a188ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 146749386_u64,
//                     pk_script:
//                     @from_hex("76a9140b0a49a0f4db52c7aa4cc913cebc49b26500d78288ac"), cached:
//                     false,
//                 },
//             ]
//                 .span(),
//         };
    ...
    //         let (tx_encoded, tx_weight) = tx.encode();
...
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b6716309948fa3b07b0a6b66804fdfd6873188ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b670791f9256bffc898f474271c22f4bb94988ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b6703d3f56427bfcfd372f952d50d04b64bd88ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b66ffe49df7fce684df16c62f59dc9adbd3f88ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
...
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b66fb6c0e253f24c74d3ed972ff447ca285c88ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b66f8567c6e527fc89b4d664069d20b0969388ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b66f6d8af8b3e984e5d807c0e1dd6964796288ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 100000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b66f5a691ff3169702d615b77d0af1451e7788ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 5000000_u64,
//                     pk_script:
//                     @from_hex("76a91406f1b66e25393fabd2b23a237e4bdfd4c2c35fac88ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 7005439842_u64,
//                     pk_script:
//                     @from_hex("76a9146e9470910291611d311ab76b89a878fead10594788ac"), cached:
//                     false,
//                 },
//             ]
//                 .span(),
...
//                     value: 102415_u64,
//                     pk_script:
//                     @from_hex("76a914998db5e1126bc3a5e04109fbf253a7900462410e88ac"), cached:
//                     false,
//                 },
//                 TxOut {
//                     value: 1424857_u64,
...
//                     value: 18000000_u64,
//                     pk_script:
//                     @from_hex("76a914ae28f233464e6da03c052155119a413d13f3380188ac"), cached:
//                     false,
//                 },
//             ]
//                 .span(),
...
//         };
    ...
    //         let (tx_encoded, tx_size) = tx.encode();
//         let tx_expected = from_hex(
